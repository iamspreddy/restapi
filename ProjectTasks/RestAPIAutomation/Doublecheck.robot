...
Create employee data using the POST method Create 10 employees data
    ...
    ${headers}    Create Dictionary    Authorization=Bearer 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    Accept=application/vnd.github.v3+json    Content-Type=application/json
