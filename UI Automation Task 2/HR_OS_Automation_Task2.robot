...
Login to HR-OS Portal
    Start Video Recording   alias=None  name=wrong password   fps=None    size_percentage=1   embed=True  embed=100px   monitor=1
    ...
    Click Next Button
    General Sleep slowness of site    25
    ...
    General Sleep slowness of site    5
    Click Request Time OFF
    General Sleep slowness of site    3
    ...
    Click Submit Button
    Sleep    5
    Capture Page Screenshot    Leavedetails.png
    ...
    Withdraw Leave Request Validation
    Capture Page Screenshot    withdrawLeave.png
    Logout HR_OS
    Switch Window   ${handles}[1]
    Logout Terralogic
...
Send Automation Report
    ${recipient}    Set Variable    recipient@example.com
