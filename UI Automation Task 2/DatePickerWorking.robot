...
Select Date
    [Arguments]    ${month}  ${year}   ${start_day}   ${end_day}    ${number_of_days}
    #Month selection
    Click Element   css:button[class="ant-picker-month-btn"]
#More Genneric
    Select Month    ${month}
    Sleep    3
#Task Related
#    Click Element    xpath:(//table[@class="ant-picker-content"]//tbody)[2]//tr[2]/td[2]
    #Year selection
    Click Element   css:button[class="ant-picker-year-btn"]
     Sleep    3
#More Genneric
    Select Year    ${year}
#    #Task Related
...
Select Year
    ...
    END
Select Days
   [Arguments]    ${number_of_days}     ${start_day}   ${end_day}

   Click Element    xpath://*[@class="ant-picker-dropdown ant-picker-dropdown-placement-bottomLeft "]//*[@title="${start_day}"]
   Click Element    xpath://*[@class="ant-picker-dropdown ant-picker-dropdown-placement-bottomLeft "]//*[@title="${end_day}"]
